...
namespace Morourak.Application.Services
{
        ...
        where TApplication : class
    {
        ...
        protected async Task<CitizenRegistry> GetCitizenAsync(string nationalId)
        {
            ...
            if (citizen == null) throw new AppEx.ValidationException("المواطن غير موجود.", "CITIZEN_NOT_FOUND");
            return citizen;
        }
        ...
        protected async Task<CitizenRegistry> GetCitizenAsync(int id)
        {
            ...
            if (citizen == null) throw new AppEx.ValidationException($"المواطن بالمعرف {id} غير موجود.", "CITIZEN_NOT_FOUND");
            return citizen;
        }
