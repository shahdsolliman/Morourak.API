        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResidenceProofPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DrivingLicenseApplications_CitizenRegistries_CitizenRegistryId",
                        column: x => x.CitizenRegistryId,
                        principalTable: "CitizenRegistries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DrivingLicenseApplications_DrivingLicenses_DrivingLicenseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VehicleLicenseApplications_InsuranceCompanies_InsuranceCompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DrivingLicenseApplications_CitizenRegistryId",
                table: "DrivingLicenseApplications",
                column: "CitizenRegistryId");

            migrationBuilder.CreateIndex(
                name: "IX_DrivingLicenseApplications_DrivingLicenseId",
                table: "DrivingLicenseApplications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleLicenseApplications_InsuranceCompanyId",
                table: "VehicleLicenseApplications",
